...
#
#   curl -fsSL https://raw.githubusercontent.com/jmpo/DeskcommCRM/main/hostgator-setup-kit/diagnostico.sh | bash
#
...
#     como `ghcr.io/jmpo/deskcomm-worker:falsificado`, e o diagnóstico
