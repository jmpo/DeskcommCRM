...
export const POLITICAS_DE_AVISO = {
  ...
  other: { refs: ["lead", "channel_session", "appointment", "ai_agent", "agent_case", "ai_provider_credential"], orientacao: "Confira a situação descrita neste aviso com a pessoa responsável." },
