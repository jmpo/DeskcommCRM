-- 0428 (era 0403 no fork; renumerada ao sincronizar com a upstream em 25/09, que usou 0403) — a etapa do funil pode mandar um evento de conversão à plataforma de anúncio.
--
