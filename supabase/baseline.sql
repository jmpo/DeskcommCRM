...
-- ---- vocabulário do terceiro canal (migration 0117) ----
-- Espelho idempotente da 0118. Racional completo no arquivo da migration; o que
...
-- ---- o que falta para o terceiro canal ENVIAR (migration 0118) ----
-- Espelho idempotente da 0118. Racional completo no arquivo da migration.
--
