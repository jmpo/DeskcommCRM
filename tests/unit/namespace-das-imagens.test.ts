...
// Este fork publica em jmpo — a ÚNICA linha que muda ao sincronizar com a
// upstream, e é exatamente para isso que a âncora única existe: antes deste
// teste, cada sync reintroduzia o namespace dele em até 31 lugares.
const NAMESPACE_DESTE_REPO = "ghcr.io/jmpo";
