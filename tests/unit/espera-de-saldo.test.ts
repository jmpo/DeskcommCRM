...
import { pushDoAvisoDaCentral } from "@/lib/notifications/push-dos-avisos";
...
describe("o aviso vai ao celular", () => {
  it("com o título da Central e o remédio, levando às credenciais", async () => {
